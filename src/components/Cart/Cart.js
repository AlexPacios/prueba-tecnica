  ...
  return (
    <div className="cart-content__product">
      ...
      <div className="cart-content__product-info">
        <div>
          <h3>{product.brand.substr(0, 25)}...</h3>
...
function CartContentFooter(props) {
  ...
  const showDeleteConfirm = () => {
    ...
    confirm({
      ...
      content: `¿Estas seguro que continuar con el pedido ${cartTotalPrice}?`,
      okText: "Aceptar",
      okType: "success",
      cancelText: "Cancelar",
      onOk() {
  ...
  return (
    <div className="cart-content__footer">
      ...
      <Button onClick={showDeleteConfirm}>Tramitar pedido</Button>
    </div>
